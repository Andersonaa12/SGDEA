    ...
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div class="flex flex-col">
                <h2 class="font-bold text-2xl text-gray-800">Crear Nuevo Expediente</h2>
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea name="detail" id="detail" rows="4"
                                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">{{ old('detail') }}</textarea>
                        ...
                        <div id="physical-location-section" class="hidden space-y-6 mt-8 p-6 bg-amber-50 border-2 border-amber-300 rounded-xl">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="folder" id="folder" value="{{ old('folder') }}"
                                ...
                                <div>
                                    ...
                                    <select name="type" id="type" class="select2 w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500" required>
                                        <option value="" disabled {{ old('type') ? '' : 'selected' }}>-- Seleccione tipo --</option>
                                        <option value="Legajo" {{ old('type') == 'Legajo' ? 'selected' : '' }}>Legajo</option>
                                        <option value="Tomo"   {{ old('type') == 'Tomo'   ? 'selected' : '' }}>Tomo</option>
                                        <option value="Libro"  {{ old('type') == 'Libro'  ? 'selected' : '' }}>Libro</option>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="volume_number" id="volume_number" value="{{ old('volume_number') }}"
                                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="folios_count" id="folios_count" value="{{ old('folios_count') }}"
                                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500">
                                ...
                                <div>
                                    ...
                                    <textarea name="additional_details" id="additional_details" rows="2"
                                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500">{{ old('additional_details') }}</textarea>
...
<script>
    $(document).ready(function() {
        var oldStructure = '{{ old('structure_id') }}';
        var oldSection = '{{ old('section_id') }}';
        var oldSubsection = '{{ old('subsection_id') }}';
        var oldSerie = '{{ old('serie_id') }}';
        var oldSubserie = '{{ old('subserie_id') }}';
