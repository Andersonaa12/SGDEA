                    ...
                    <form action="{{ route('organizational-structures.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="4"
                                      class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition">{{ old('description') }}</textarea>
                        ...
                        <div>
                            <label class="flex items-center space-x-3 cursor-pointer">
                                <input type="checkbox" name="active" id="active" {{ old('active', true) ? 'checked' : '' }}
