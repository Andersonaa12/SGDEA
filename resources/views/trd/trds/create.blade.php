        ...
        <div class="flex items-center gap-4">
            ...
            <div class="flex flex-col">
                ...
                <nav class="flex text-sm text-gray-600 mt-1">
                    ...
                    <span class="text-indigo-600 font-medium">Crear TRD</span>
                </nav>
            </div>
        </div>
    </x-slot>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-xl rounded-lg overflow-hidden">
                <div class="p-8">
                    ...
                    <form action="{{ route('trds.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                        @csrf
                        ...
                        <div>
                            ...
                            <input type="number" name="version" id="version" value="{{ old('version') }}"
                        ...
                        <div>
                            ...
                            <input type="date" name="valid_to" id="valid_to" value="{{ old('valid_to') }}"
                                   ...
                                   placeholder="Dejar vacío si es vigente indefinidamente">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-2">Máximo 10MB. Solo PDF.</p>
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600 mt-1">Desmarca si esta TRD ya no está vigente</p>
                        </div>
