        ...
        <div class="flex items-center gap-4">
            ...
            <div class="flex flex-col">
                ...
                <nav class="flex text-sm text-gray-600 mt-1">
                    ...
                    <span class="text-indigo-600 font-medium">Editar {{ $permission->name }}</span>
                </nav>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-2">
        <div class="max-w-8xl mx-auto sm:px-6 lg:px-8 py-4">
            <div class="bg-white shadow-xl rounded-lg overflow-hidden">
                <div class="p-8">
                    <form action="{{ route('users.permissions.update', $permission) }}" method="POST" class="space-y-8">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="bg-indigo-50 p-4 rounded-lg">
                                    <p class="text-sm text-indigo-700">Consejo: Cambiar el nombre del permiso podría afectar roles asignados. Verifica antes de actualizar.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex gap-4 pt-8 border-t">
                            ...
                            <a href="{{ route('users.permissions.show', $permission) }}"
